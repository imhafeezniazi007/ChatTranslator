package translate.chat.translator.keyboard.iphonekeyboard.all.languages.translator.Fragments;
...
public class ChatTranslatorDefault extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TemplateView nativeAdView = view.findViewById(R.id.nativeChatad);

        AdManager adManager = new AdManager((Activity) view.getContext(), nativeAdView);
