...
import translate.chat.translator.keyboard.iphonekeyboard.all.languages.translator.Services.LanguageApiService;
import translate.chat.translator.keyboard.iphonekeyboard.all.languages.translator.Services.SpeechToTextService;
import translate.chat.translator.keyboard.iphonekeyboard.all.languages.translator.Services.TextToSpeechManager;
import translate.chat.translator.keyboard.iphonekeyboard.all.languages.translator.Services.TextTranslateService;
...
public class VoiceTranslatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityVoiceTranslatorBinding.toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showInterstitialAd() {
        AdManager adManager = new AdManager(VoiceTranslatorActivity.this);
