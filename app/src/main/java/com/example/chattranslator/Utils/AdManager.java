package com.example.chattranslator.Utils;
...
import com.example.chattranslator.OnAdsCallback;
...
public class AdManager {
    ...
    public AdManager(Context context, String placement) {
        mContext = context;
        mPlacement = placement;
    }

    public AdManager(Context context, TemplateView adView) {
        mContext = context;
        mNativeAdView = adView;
    }

    public AdManager(Context context, AdView adView, String placement) {
        mContext = context;
        mAdView = adView;
        mPlacement = placement;
    }
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd loadedInterstitialAd) {
                        if (loadedInterstitialAd != null) {
                            ...
                            loadedInterstitialAd.show((Activity) mContext);
                        } else {
